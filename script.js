...
function typeWriter() {
    ...
    const texts = ['Master Cybersecurity', 'Learn Ethical Hacking', 'Secure the Future', 'Become an Expert'];
    let textIndex = 0;
    let charIndex = 0;
...
// Lab item interactions
document.querySelectorAll('.lab-item').forEach(item => {
    item.addEventListener('click', () => {
        const labName = item.querySelector('span').textContent;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Add some delay to counter animation
    setTimeout(() => {
